...
You can also access the whole git for this project [here](https://github.com/tsenegas/cricketML) and install all the packages used using renv, see code below:
